...
export default {
  components: {
    ...
    FormModal1: () => import("../patrolInspectionRecord/FormModal.vue"),
  },
  data() {
    return {
      columns: [
  ...
  methods: {
    initialize() {
      this.items = [
        { id: 1, position: "控制", standard: "开关/按钮/显示器/指示灯齐全有效无破损", execution_cycle: "每班", execution_sequence: "开机前", remark: "" },
        { id: 2, position: "机械机构", standard: "正常开机, 通过系统自检程序, 正常运行", execution_cycle: "每班", execution_sequence: "开机前", remark: "" },
      ];
      // this.list();
    },
    list() {
