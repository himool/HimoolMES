  ...
  <div>
      <a-row gutter="16">
        ...
        <!-- <div style="margin-bottom: 12px; float: right;">
          <a-button type="primary" icon="plus" style="margin: 0 8px;" @click="openFormModal({})">新增维保记录</a-button>
        </div> -->
      </a-row>
...
export default {
  ...
  methods: {
    initialize() {
      this.items = [
        { id: 1, device_number: "D001", device_name: "设备1", time: "2022-06-02", remark: "" },
        { id: 1, device_number: "D002", device_name: "设备2", time: "2022-06-03", remark: "" },
      ];
      // this.list();
    },
    list() {
