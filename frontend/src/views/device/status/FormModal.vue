<template>
  <div>
    <a-modal v-model="visible" :confirmLoading="loading" :maskClosable="false" @cancel="cancel" @ok="confirm">
      <div slot="title">{{ form.id ? "编辑设备状态" : "新增设备状态" }}</div>
      <div>
        <a-form-model ref="form" :model="form" :rules="rules" :label-col="{ span: 4 }" :wrapper-col="{ span: 16 }">
          <a-form-model-item prop="device_number" label="设备编号">
            <a-input v-model="form.device_number" allowClear />
          </a-form-model-item>
          <a-form-model-item prop="device_name" label="设备名称">
            <a-input v-model="form.device_name" allowClear />
          </a-form-model-item>
          <a-form-model-item prop="device_status" label="设备状态">
            <a-input v-model="form.device_status" allowClear />
          </a-form-model-item>
          <a-form-model-item prop="start_time" label="开始时间">
            <a-input v-model="form.start_time" allowClear />
          </a-form-model-item>
          <a-form-model-item prop="end_time" label="结束时间">
            <a-input v-model="form.end_time" allowClear />
          </a-form-model-item>
