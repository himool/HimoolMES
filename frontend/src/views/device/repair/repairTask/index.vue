  ...
  <div>
      <a-row gutter="16">
        ...
        <div style="margin-bottom: 12px; float: right;">
          <a-button type="primary" icon="plus" style="margin: 0 8px;" @click="openFormModal({})">新增维修任务</a-button>
        </div>
      </a-row>
      ...
      <a-row style="margin-top: 12px;">
        ...
        >
          <div slot="action" slot-scope="value, item">
            <a-button icon="edit" size="small" @click="visible1 = true">维修</a-button>
...
export default {
  components: {
    ...
    FormModal1: () => import("../repairRecord/FormModal.vue"),
  },
  data() {
    return {
      columns: [
  ...
  methods: {
    initialize() {
      this.items = [
        { id: 1, device_number: "D001", device_name: "设备1", time: "2022-06-01", remark: "无法运行" },
        { id: 1, device_number: "D002", device_name: "设备2", time: "2022-06-02", remark: "无法运行" },
      ];
      // this.list();
    },
    list() {
